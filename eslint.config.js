...
export default tseslint.config(
  ...
  { files: ["scripts/build-demo-feed.mjs", "scripts/build-hosted.mjs", "scripts/build-pages.mjs"], languageOptions: { globals: { console:"readonly", fetch:"readonly", process:"readonly" } } },
