...
**Přečteno se řídí samo.** Nastaví ho otevření originálu i rozbalení položky ve feedu; obojí je čtení. Ruční přepínač zůstává jen v „···“ jako oprava, ne jako každodenní akce, a pouhé projetí karty scrollováním read nenastavuje. Přečtená karta se během aktivního scrollu jen ztlumí, nezmizí a nepřeskládá okolí; filtr se znovu uplatní až při přepnutí pohledu nebo novém načtení. Klient si proto drží pořadí feedu a položku, která ze serverového proudu vypadla, vrací na její místo — jinak by čtenář po každém přečtení ztratil kontext, kde ve feedu je.
